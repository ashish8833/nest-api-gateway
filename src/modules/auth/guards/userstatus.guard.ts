...
import { CAuthMessage, ENUM_ACCESS_TOKEN_CODE_ERROR, ENUM_USER_ROLE_AND_STATUS_ERROR } from "../constants/auth.constant";
...
export class UserStatus implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        const user = await this.userRepository.findByPk(uuid, { raw: true, nest: true });
